...
public class UserQueryTests
{
    ...
    private readonly Mock<IGoogleTokenVerifier> _googleValidatorMock;
    ...
    public UserQueryTests()
    {
        ...
        _googleValidatorMock = new Mock<IGoogleTokenVerifier>();
    ...
    public async Task F023_01_UserFoundWithMatchingGoogleId_ReturnsAuthResponse()
    {
        ...
        _googleValidatorMock.Setup(v => v.VerifyTokenAsync(It.IsAny<string>()))
        ...
        result.RefreshToken.Should().NotBeNullOrEmpty();
        result.UserProfile.Should().NotBeNull();
        _googleValidatorMock.Verify(v => v.VerifyTokenAsync("valid-google-token"), Times.Once);
    }
