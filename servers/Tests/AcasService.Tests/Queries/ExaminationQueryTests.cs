...
namespace AcasService.Tests.Queries
{
    public class ExaminationQueryTests
    {
        ...
        private readonly Mock<ExaminationMapper> _mockExaminationMapper;
        private readonly Mock<ProblemMapper> _mockProblemMapper;
        ...
        public ExaminationQueryTests()
        {
            ...
            _mockExaminationMapper = new Mock<ExaminationMapper>();
            _mockProblemMapper = new Mock<ProblemMapper>();
        ...
        public async Task GetByIdAsync_WithValidId_ReturnsExaminationResponse()
        {
            ...
            var classroom = new Classroom { Id = "class1", ClassName = "C#101" };
            ...
            _mockExaminationMapper.Setup(m => m.ToExaminationResponse(exam, classroom, language)).Returns(examinationResponse);
        ...
        public async Task GetAllAsync_WithValidExaminations_ReturnsAllExaminations()
        {
            ...
            {
                new Classroom { Id = "class1", ClassName = "C#101" },
                new Classroom { Id = "class2", ClassName = "Java101" }
            };
            ...
            _mockExaminationMapper.Setup(m => m.ToExaminationResponse(It.IsAny<Examination>(), It.IsAny<Classroom>(), It.IsAny<ProgrammingLanguage>()))
                .Returns((Examination e, Classroom c, ProgrammingLanguage l) => e.Id == "exam1" ? examResponse1 : examResponse2);
        ...
        public async Task GetByClassIdAsync_WithValidClassId_ReturnsClassExaminations()
        {
            ...
            var classroom = new Classroom { Id = classId, ClassName = "C#101" };
            var language = new ProgrammingLanguage { Id = "lang1", Name = "C#" };
            ...
            _mockClassroomRepository.Setup(r => r.FindByIdsAsync(It.IsAny<List<string>>())).ReturnsAsync(new List<Classroom> { classroom });
            _mockExaminationMapper.Setup(m => m.ToExaminationResponse(It.IsAny<Examination>(), It.IsAny<Classroom>(), It.IsAny<ProgrammingLanguage>())).Returns(examResponse);
        ...
        public async Task GetExaminationProblemResponseAsync_WithValidExamAndProblem_ReturnsProblemResponse()
        {
            ...
            _mockProgrammingLanguageRepository.Setup(r => r.GetByIdAsync("lang1")).ReturnsAsync(language);
            _mockProblemMapper.Setup(m => m.ToProblemResponse(problem)).Returns(problemResponse);
            _mockExaminationMapper.Setup(m => m.ToExaminationWithSpecProblem(exam, It.IsAny<ProblemResponse>(), language)).Returns(new ExaminationSpecProblemResponse());
        ...
        public async Task GetExaminationProblemResponseAsync_FilterPublicTestCases()
        {
            ...
            _mockProblemMapper.Setup(m => m.ToProblemResponse(problem)).Returns(problemResponse);
            _mockExaminationMapper.Setup(m => m.ToExaminationWithSpecProblem(It.IsAny<Examination>(), It.IsAny<ProblemResponse>(), It.IsAny<ProgrammingLanguage>()))
                .Returns<Examination, ProblemResponse, ProgrammingLanguage>((e, p, l) =>
                {
            ...
            _mockExaminationMapper.Verify(m => m.ToExaminationWithSpecProblem(
                It.IsAny<Examination>(),
                It.Is<ProblemResponse>(p => p.TestCases.Count == 2 && p.TestCases.All(tc => tc.IsPublic)),
                It.IsAny<ProgrammingLanguage>()), Times.Once);
        }
