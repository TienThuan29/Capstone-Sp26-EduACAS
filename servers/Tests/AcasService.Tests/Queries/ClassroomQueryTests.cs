...
namespace AcasService.Tests.Queries
{
    public class ClassroomQueryTests
    {
        ...
        public ClassroomQueryTests()
        {
            ...
            _classroomMapper = new ClassroomMapper();
        ...
        public async Task GetAllClassroomsAsync_WithValidParameters_ReturnsPagedClassrooms()
        {
            ...
            {
                new global::AcasService.Models.Classroom { Id = "class1", ClassName = "C#101", ClassCode = "CS101", SubjectId = "sub1", LecturerId = "lecturer1", IsDeleted = false, EndDate = DateTime.UtcNow.AddDays(1), CreatedDate = DateTime.UtcNow }
            };
        ...
        public async Task GetAllClassroomsAsync_WithSearch_FiltersClassroomsByName()
        {
            ...
            {
                new global::AcasService.Models.Classroom { Id = "class1", ClassName = "C#101", ClassCode = "CS101", SubjectId = "sub1", LecturerId = "lecturer1", IsDeleted = false, EndDate = DateTime.UtcNow.AddDays(1), CreatedDate = DateTime.UtcNow },
                new global::AcasService.Models.Classroom { Id = "class2", ClassName = "Java101", ClassCode = "JA101", SubjectId = "sub2", LecturerId = "lecturer2", IsDeleted = false, EndDate = DateTime.UtcNow.AddDays(1), CreatedDate = DateTime.UtcNow }
            };
            var subjects = new List<Subject> { new Subject { Id = "sub1", SubjectName = "C#" } };
            var userProfiles = new List<UserProfileResponse> { new UserProfileResponse { Id = "lecturer1", Fullname = "John Doe" } };
            var classroomResponse = new ClassroomResponse { Id = "class1", ClassName = "C#101" };
        ...
        public async Task GetAllClassroomsAsync_WithStatusActive_ReturnsActiveClassrooms()
        {
            ...
            var classrooms = new List<global::AcasService.Models.Classroom>
            {
                new global::AcasService.Models.Classroom { Id = "class1", ClassName = "C#101", ClassCode = "CS101", SubjectId = "sub1", LecturerId = "lecturer1", IsDeleted = false, EndDate = now.AddDays(1), CreatedDate = now },
                new global::AcasService.Models.Classroom { Id = "class2", ClassName = "Java101", ClassCode = "JA101", SubjectId = "sub2", LecturerId = "lecturer2", IsDeleted = false, EndDate = now.AddDays(-1), CreatedDate = now }
            };
        ...
        public async Task GetAllClassroomsAsync_WithPagination_ReturnsCorrectPage()
        {
            ...
            var classrooms = Enumerable.Range(1, 25)
                .Select(i => new global::AcasService.Models.Classroom
                {
                    Id = $"class{i}",
                    ClassName = $"Class{i}",
                    ClassCode = $"CC{i}",
        ...
        public async Task GetAllClassroomsAsync_WithDeletedClassrooms_ExcludesDeletedByDefault()
        {
            ...
            {
                new global::AcasService.Models.Classroom { Id = "class1", ClassName = "C#101", ClassCode = "CS101", SubjectId = "sub1", LecturerId = "lecturer1", IsDeleted = false, EndDate = DateTime.UtcNow.AddDays(1), CreatedDate = DateTime.UtcNow },
                new global::AcasService.Models.Classroom { Id = "class2", ClassName = "Java101", ClassCode = "JA101", SubjectId = "sub2", LecturerId = "lecturer2", IsDeleted = true, EndDate = DateTime.UtcNow.AddDays(1), CreatedDate = DateTime.UtcNow }
            };
        ...
        public async Task GetClassroomsByKeywordAsync_WithValidKeyword_ReturnsMatchingClassrooms()
        {
            ...
            var classrooms = new List<global::AcasService.Models.Classroom>
            {
                new global::AcasService.Models.Classroom { Id = "class1", ClassName = "C#101", ClassCode = "CS101", SubjectId = "sub1", LecturerId = "lecturer1", IsDeleted = false }
            };
            var subjects = new List<Subject> { new Subject { Id = "sub1", SubjectName = "C#" } };
            var userProfiles = new List<UserProfileResponse> { new UserProfileResponse { Id = "lecturer1", Fullname = "John Doe" } };
            var classroomResponse = new ClassroomResponse { Id = "class1", ClassName = "C#101" };
        ...
        public async Task GetClassroomsByKeywordAsync_WithNoMatch_ReturnsEmptyList()
        {
            ...
            _mockClassroomRepository.Setup(r => r.GetClassroomsByKeywordAsync("NONEXISTENT")).ReturnsAsync(new List<global::AcasService.Models.Classroom>());
        ...
        public async Task GetClassroomsByLecturerIdAsync_WithValidLecturerId_ReturnsLecturerClassrooms()
        {
            ...
            var classrooms = new List<global::AcasService.Models.Classroom>
            {
                new global::AcasService.Models.Classroom { Id = "class1", ClassName = "C#101", ClassCode = "CS101", SubjectId = "sub1", LecturerId = lecturerId, IsDeleted = false, EndDate = DateTime.UtcNow.AddDays(1), CreatedDate = DateTime.UtcNow }
            };
            var subjects = new List<Subject> { new Subject { Id = "sub1", SubjectName = "C#" } };
            var userProfiles = new List<UserProfileResponse> { new UserProfileResponse { Id = "lecturer1", Fullname = "John Doe" } };
            var classroomResponse = new ClassroomResponse { Id = "class1", ClassName = "C#101" };
        ...
        public async Task GetClassroomsByLecturerIdAsync_WithSearch_FiltersClassroomsByName()
        {
            ...
            {
                new global::AcasService.Models.Classroom { Id = "class1", ClassName = "C#101", ClassCode = "CS101", SubjectId = "sub1", LecturerId = lecturerId, IsDeleted = false, EndDate = DateTime.UtcNow.AddDays(1), CreatedDate = DateTime.UtcNow },
                new global::AcasService.Models.Classroom { Id = "class2", ClassName = "Java101", ClassCode = "JA101", SubjectId = "sub2", LecturerId = lecturerId, IsDeleted = false, EndDate = DateTime.UtcNow.AddDays(1), CreatedDate = DateTime.UtcNow }
            };
            var subjects = new List<Subject> { new Subject { Id = "sub1", SubjectName = "C#" } };
            var userProfiles = new List<UserProfileResponse> { new UserProfileResponse { Id = "lecturer1", Fullname = "John Doe" } };
            var classroomResponse = new ClassroomResponse { Id = "class1", ClassName = "C#101" };
