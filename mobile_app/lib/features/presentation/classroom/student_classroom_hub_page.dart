            ...
            Expanded(
              child: _HubCard(
                ...
                gradient: const LinearGradient(
                  ...
                  colors: [Color(0xFF154360), Color(0xFF2E86AB)],
                ),
...
class _ClassroomTabPageState extends State<_ClassroomTabPage>
  ...
  void initState() {
    super.initState();
    final safeIndex = widget.initialTabIndex.clamp(0, 5);
    _tabController = TabController(length: 6, initialIndex: safeIndex, vsync: this);
  }
