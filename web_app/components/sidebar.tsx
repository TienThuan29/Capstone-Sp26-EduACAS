...
const Sidebar = () => {
  ...
  const AssignmentsIcon = () => (
    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <line x1="12" y1="19" x2="12" y2="11" stroke="currentColor" strokeWidth="2" fill="none" />
      <line x1="9" y1="16" x2="15" y2="16" stroke="currentColor" strokeWidth="2" fill="none" />
    </svg>
  )
    ...
    >
      ...
      <div className={`border-t ${isDarkMode ? "border-gray-700" : "border-gray-200"} p-4 space-y-2`}>
        ...
        >
          ...
          {isExpanded && <span className="text-sm">{isDarkMode ? "Light Mode" : "Dark Mode"}</span>}
        </button>
